...
class PlaneTest {
    ...
    @Test
    void testJson() {
        Plane plane = new Plane(new JSONObject("{\"p1\":{\"d\":{\"value\":3} }, \"p2\":{\"x\":4, \"y\":5, \"z\":6}, \"p3\":{\"d\":{\"value\":7} } }"));
        assertEquals(3, plane.getQ0().getX());
        assertEquals(8, plane.getNormal().getY());

        plane = new Plane(new JSONObject("{\"p0\":{\"d\":{\"value\":0} }, \"normal\":{\"x\":0, \"y\":0, \"z\":1} }"));
        assertEquals(0, plane.getQ0().getX());
        assertEquals(1, plane.getNormal().getZ());
