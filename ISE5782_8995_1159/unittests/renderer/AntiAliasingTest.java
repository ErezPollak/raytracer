...
public class AntiAliasingTest {
    ...
    void ItayTest(){
        ...
        Color emission = new Color(BLUE);
        Material material = new Material().setKd(0.5).setKs(0.5).setShininess(30);

        Intersectable sphere = new Sphere(new Point(0, 0, -60), 60d).setEmission(emission).setMaterial(material);
        ...
        camera.setImageWriter(new ImageWriter("ItayTestPic", 500, 500)) //
                .renderImage() //
                .writeToImage();
    }
